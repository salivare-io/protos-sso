...
const file_proto_sso_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x04Auth\x12HПринудительная инвалидация refresh токена\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/auth/revokeB\x8a\x03\x92A\xf8\x01\x12\x92\x01\n" +
	...
	"\x0fcom.sso.auth.v1B\tAuthProtoP\x01Z\"Salivare-DevHub/sso.auth.v1;authv1\xa2\x02\x03SAX\xaa\x02\vSso.Auth.V1\xca\x02\vSso\\Auth\\V1\xe2\x02\x17Sso\\Auth\\V1\\GPBMetadata\xea\x02\rSso::Auth::V1b\x06proto3"
